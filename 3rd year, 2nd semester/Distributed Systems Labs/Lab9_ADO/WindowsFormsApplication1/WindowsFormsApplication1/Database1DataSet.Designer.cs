...
namespace WindowsFormsApplication1 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class PersoanaDataTable : global::System.Data.TypedTableBase<PersoanaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PersoanaRow AddPersoanaRow(int Id, string Nume, int Varsta) {
        ...
        public partial class PersoanaRow : global::System.Data.DataRow {
            ...
            public int Varsta {
                get {
                    try {
                        return ((int)(this[this.tablePersoana.VarstaColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Varsta\' in table \'Persoana\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablePersoana.VarstaColumn] = value;
                }
            }
            ...
            public bool IsVarstaNull() {
                return this.IsNull(this.tablePersoana.VarstaColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetVarstaNull() {
                this[this.tablePersoana.VarstaColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace WindowsFormsApplication1.Database1DataSetTableAdapters {
    ...
    public partial class PersoanaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Persoana] WHERE (([Id] = @Original_Id) AND ((@IsNull_Nume = 1 " +
                "AND [Nume] IS NULL) OR ([Nume] = @Original_Nume)) AND ((@IsNull_Varsta = 1 AND [" +
                "Varsta] IS NULL) OR ([Varsta] = @Original_Varsta)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Persoana] ([Id], [Nume], [Varsta]) VALUES (@Id, @Nume, @Varsta" +
                ");\r\nSELECT Id, Nume, Varsta FROM Persoana WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Persoana] SET [Id] = @Id, [Nume] = @Nume, [Varsta] = @Varsta WHERE (([Id] = @Original_Id) AND ((@IsNull_Nume = 1 AND [Nume] IS NULL) OR ([Nume] = @Original_Nume)) AND ((@IsNull_Varsta = 1 AND [Varsta] IS NULL) OR ([Varsta] = @Original_Varsta)));
SELECT Id, Nume, Varsta FROM Persoana WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nume, Varsta FROM dbo.Persoana";
        ...
        public virtual int Fill(Database1DataSet.PersoanaDataTable dataTable) {
        ...
        public virtual Database1DataSet.PersoanaDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet.PersoanaDataTable dataTable = new Database1DataSet.PersoanaDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet.PersoanaDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Nume, global::System.Nullable<int> Original_Varsta) {
        ...
        public virtual int Insert(int Id, string Nume, global::System.Nullable<int> Varsta) {
        ...
        public virtual int Update(int Id, string Nume, global::System.Nullable<int> Varsta, int Original_Id, string Original_Nume, global::System.Nullable<int> Original_Varsta) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nume, global::System.Nullable<int> Varsta, int Original_Id, string Original_Nume, global::System.Nullable<int> Original_Varsta) {
            return this.Update(Original_Id, Nume, Varsta, Original_Id, Original_Nume, Original_Varsta);
        }
    }
