...
namespace Client.SimpleMath {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="SimpleMathSoap", Namespace="http://tempuri.org/")]
    public partial class SimpleMath : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public SimpleMath() {
            this.Url = global::Client.Properties.Settings.Default.Client_SimpleMath_SimpleMath;
        ...
        /// <remarks/>
        public void SubtractAsync(int n1, int n2) {
            this.SubtractAsync(n1, n2, null);
        }
        
        /// <remarks/>
        public void SubtractAsync(int n1, int n2, object userState) {
